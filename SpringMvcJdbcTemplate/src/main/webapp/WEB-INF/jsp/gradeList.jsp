    ...
    <div class="page">
     ...
     <%@include file="includeFile/navAdmin.jsp"%>
      ...
      <section class="dashboard-counts padding">
         <h4 class="page-head-line">Liste des grades</strong></h4>
      </section>
      <!-- Header Section-->
         ...
         <div class="row">
                <div class="col-md-6 table-responsive">
		             <table class="table table-bordered table-striped table-condensed">
		             	<c:forEach items="${grades}" var="i" varStatus="pos">
		             	  <tr class="active">
							<td><c:out value="${pos.count}"></c:out></td>
							<td><c:out value="${i.gradeName }"></c:out></td>
						   </tr>
						 </c:forEach>
		             </table>
