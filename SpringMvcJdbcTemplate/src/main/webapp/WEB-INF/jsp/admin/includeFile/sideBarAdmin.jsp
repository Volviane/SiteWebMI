      ...
      <div class="side-navbar-wrapper menu">
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            ...
            <li><a href="${pageContext.request.contextPath}/openAcademicYear"> <i class=""></i>Ouvrir une année                          </a></li>
            ...
            <li><a href="#item2" aria-expanded="false" data-toggle="collapse"> <i class=""></i>Listing </a>
              <ul id="item2" class="collapse list-unstyled ">
                ...
                <li><a href="${pageContext.request.contextPath}/gradeList">Liste des grades </a></li>
                 ...
                 <li><a href="${pageContext.request.contextPath}/listNews">Liste des communiqués </a></li>
                 <li><a href="${pageContext.request.contextPath}/listEvent">Liste des évènement </a></li>
