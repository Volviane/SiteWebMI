...
<html>
  <head>
    ...
    <title>liste des Domaines de recherche</title>
    ...
    <div class="page">
     ...
     <%@include file="includeFile/navAdmin.jsp"%>
      ...
      <section class="dashboard-counts padding">
         <h4 class="page-head-line">Liste des Domaines de recherches</strong></h4>
      </section>
      <!-- Header Section-->
         ...
         <div class="row">
                <div class="offset-1 col-md-6 table-responsive">
		             <table class="table table-bordered table-striped table-condensed">
		             	<tr class="active">
							<td>N°</td>
							<td>domaines de recherches</td>
						   </tr>
		             	<c:forEach items="${researchDomains}" var="i" varStatus="pos">
		             	   
		             	  <tr class="info">
							<td><c:out value="${pos.count}"></c:out></td>
							<td><c:out value="${i.domainLabel }"></c:out></td>
						   </tr>
						 </c:forEach>
		             </table>
