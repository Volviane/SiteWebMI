...
<html>
  <head>
    ...
    <title>Ajouter un domaine de recherche</title>
    ...
    <div class="page">
     ...
     <%@include file="includeFile/navAdmin.jsp"%>
      ...
      <section class="dashboard-counts padding">
          <h4 class="page-head-line">Ajouter un domaine de recherche</strong></h4>
      </section>
      <!-- Header Section-->
      <section class="dashboard-header padding">
         <div class="row">
                <div class="col-md-6">
		              <form action="<c:url value='addResearchDomain'/>" method="post">
                     ...
                     <label>option</label>
                    	 ...
                    	 <select class="form-control" name="optionName">
                    		...
                    		<div class="form-group">
                      			  ...
                      			  <input type="text" class="form-control" name="domainLabel" required />
                             </div>
                            <label>Description</label>
                      			<textarea rows="5" cols="5" class="form-control" name="domainDescription" required></textarea>
                       
                        <hr />
                        <input type="submit" value="Enregistrer" class="btn btn-info">
                        <hr />
                         <c:if test="${error!=null}">
							<h6 class="alert"> <font color="red">${error}</font></h6>
			       		</c:if>
			        	<c:if test="${error==null}">
							<h6 class="alert alert-success"> <font color="green">enregistrement reussi</font></h6>
			       		</c:if>
                </form>
