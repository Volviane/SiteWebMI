	...
	<script
		src="${pageContext.request.contextPath}/resources/css/assets/assets/plugins/modernizr-2.6.2-respond-1.1.0.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/resources/css/assets/assets/js/validationInit.js"></script>
	<script
		src="${pageContext.request.contextPath}/resources/css/assets/assets/plugins/jquery-validation-1.11.1/dist/jquery.validate.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/resources/css/assets/assets/plugins/validationengine/js/languages/jquery.validationEngine-en.js"></script>
	
	<script
		src="${pageContext.request.contextPath}/resources/css/assets/assets/plugins/validationengine/js/jquery.validationEngine.js"></script>
	<script
